class SetBackBuilding extends BoxBuilding{
  ...
  define_set_backs(){
    ...
    for (let i=0; i<this.set_back_ratio.length; i++){
      ...
      let current_height = i*z_segment_length;
      let set_back = new BoxBuilding(this.cx, this.cy, current_height, ratio_x, ratio_y, z_segment_length, color(177,127,87), maxDisplacement);
